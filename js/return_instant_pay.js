...
$.get("ajaxbills.php?find_ret_instant=date&date="+date, function(data){
$('.customer_auto_search_name').remove();
$('.product_auto_search_name').remove();
$('.auto_search_msg').remove();
...
$.get("ajaxbills.php?find_ret_instant=num&num="+num, function(data){
$('.customer_auto_search_name').remove();
$('.product_auto_search_name').remove();
$('.auto_search_msg').remove();
$('.products_list').remove();
...
$.get("ajaxbills.php?find_ret_instant=name&id="+id, function(data){
$('.customer_auto_search_name').remove();
$('.product_auto_search_name').remove();
$('.auto_search_msg').remove();
$('.products_list').remove();
...
if(c){login_modal("ازالة طلبية","ajaxbills.php?update_temp_bills=del_ret_inst&id="+id);}
}

function search_instant_pay_partner(){
$('.customer_auto_search_name').remove();$('.auto_search_msg').remove();$('.msg').remove();
var id=document.getElementById("select_partner").value;
$.get("ajaxbills.php?find_ret_instant=partner&id="+id, function(data){
$('.customer_auto_search_name').remove();
$('.product_auto_search_name').remove();
$('.auto_search_msg').remove();
$('.products_list').remove();
...
$.get("ajaxbills.php?find_ret_instant=employee&id="+id, function(data){
$('.customer_auto_search_name').remove();
$('.product_auto_search_name').remove();
$('.auto_search_msg').remove();
$('.products_list').remove();
